...
(
	[laua_kategooria_kood] Text(5) NOT NULL,
	[laua_kategooria_tyyp_kood] Text(5) NOT NULL,
	[nimetus] Text(50) NOT NULL
)
;
...
(
	[laua_varvus_kood] Text(5) NOT NULL,
	[nimetus] Text(50) NOT NULL
)
;
...
CREATE INDEX [IXFK_Laud_Laua_varvus] ON [Laud] ([laua_värvus_kood] ASC)
;

CREATE INDEX [IXFK_Laud_Tootaja] ON [Laud] ([registreerija_isik_id] ASC)
;
...
ALTER TABLE [Isik] ADD CONSTRAINT [AK_Isik_Isikukood_Isikukood_riik] UNIQUE ([isikukood],[isikukoodi_riik])
;
...
ALTER TABLE [Kliendi_seisundi_liik] ADD CONSTRAINT [AK_Kliendi_seisundi_liik] UNIQUE ([nimetus])
;
...
ALTER TABLE [Laua_kategooria] ADD CONSTRAINT [AK_Laua_kategooria_tyyp_koos_nimetus] UNIQUE ([nimetus],[laua_kategooria_tyyp_kood])
;
...
ALTER TABLE [Laua_kategooria_tyyp] ADD CONSTRAINT [AK_Laua_kategooria_tyyp_nimetus] UNIQUE ([nimetus])
;
...
ALTER TABLE [Laua_seisundi_liik] ADD CONSTRAINT [AK_Laua_seisundi_liik_nimetus] UNIQUE ([nimetus])
;
...
ALTER TABLE [Laua_varvus] ADD CONSTRAINT [AK_Laua_varvus_nimetus] UNIQUE ([nimetus])
;
...
ALTER TABLE [Tootaja] ADD CONSTRAINT [FK_Mentor]
	FOREIGN KEY ([mentor_id]) REFERENCES [Tootaja] ([tootaja_id]) ON UPDATE Cascade
;
